...
from gupdater.downloader.driver import FileDriver
# from gupdater.common.conf import CONF
from gupdater.common.exception import FtpException

LOG = Logger().getLogger()

class FtpDriver(FileDriver):
...
#ftp_driver = FtpDriver(host='20.251.32.20', port=21, username='test', password='test', timeout=600)
ftp_driver.connect()
ftp_driver.upload(breakpoint=False, local_path='aa')
#ftp_driver.upload(breakpoint=False, local_path='/home/eclipse-jee-luna-SR2-linux-gtk-x86_64.tar.gz')
#ftp_driver.download(breakpoint=True, remote_path='aaa', local_path='/home/test_ftp/eclipse')
#ftp_driver.test()
